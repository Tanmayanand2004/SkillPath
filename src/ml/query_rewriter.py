...
class QueryRewriter:
    ...
    def __init__(
        ...
        Args:
            ...
            model: Model to use for rewriting (defaults to the configured LLM)
        ...
        try:
            ...
            print(f"✅ Query rewriter initialized (model: {self.model})")
        except Exception as exc:
            print(f"❌ Query rewriting disabled: {exc}")
